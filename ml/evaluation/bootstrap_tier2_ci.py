...
def main() -> None:
    ...
    results_path = data_root / f"ml/outputs/evaluation/{_gen}/tier2_bertscore_results.csv"
    ...
    out_path = data_root / f"ml/outputs/evaluation/{_gen}/tier2_bootstrap_summary.csv"
